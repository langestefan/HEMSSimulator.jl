...
[![Stable Documentation](https://img.shields.io/badge/docs-stable-blue.svg)](https://langestefan.github.io/HEMSSimulator.jl/stable)
[![Development documentation](https://img.shields.io/badge/docs-dev-blue.svg)](https://langestefan.github.io/HEMSSimulator.jl/dev)
...
[![Docs workflow Status](https://github.com/langestefan/HEMSSimulator.jl/actions/workflows/Docs.yml/badge.svg?branch=main)](https://github.com/langestefan/HEMSSimulator.jl/actions/workflows/Docs.yml?query=branch%3Amain)
...
If you want to make contributions of any kind, please first that a look into our [contributing guide directly on GitHub](docs/src/90-contributing.md) or the [contributing page on the website](https://langestefan.github.io/HEMSSimulator.jl/dev/90-contributing/)
